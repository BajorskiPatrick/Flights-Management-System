...
class FlightDaoTest {
    ...
    void testSaveAndFindById() throws DatabaseActionException, SQLException {
        Flight flight = new Flight("Warsaw", "London", LocalDateTime.now().plusDays(1), 120, 10, false);
        ...
        assertFalse(foundFlight.getTwoWay());
    ...
    void testUpdate() throws DatabaseActionException, SQLException {
        Flight flight = new Flight("Berlin", "Paris", LocalDateTime.now().plusDays(2), 90, 8, true);

        int id = flightDao.save(flight);

        flight.setId(id);
        flight.setDestination("Rome");
        flight.setTwoWay(false);
        flightDao.update(flight);

        Flight updatedFlight = flightDao.findById(id);
        assertEquals("Rome", updatedFlight.getDestination());
        assertFalse(updatedFlight.getTwoWay());
    ...
    void testFindByDeparture() throws DatabaseActionException, SQLException {
        Flight flight1 = new Flight("Madrid", "Barcelona", LocalDateTime.now().plusDays(3), 60, 5, true);
        Flight flight2 = new Flight("Madrid", "Lisbon", LocalDateTime.now().plusDays(4), 90, 7, false);
    ...
    void testFindByDestination() throws DatabaseActionException, SQLException {
        Flight flight1 = new Flight("Berlin", "Paris", LocalDateTime.now().plusDays(1), 90, 5, false);
        Flight flight2 = new Flight("London", "Paris", LocalDateTime.now().plusDays(2), 120, 7, true);
    ...
    void testFindByDate() throws DatabaseActionException, SQLException {
        ...
        Flight flight1 = new Flight("Warsaw", "London", testDate.atTime(10, 0), 120, 5, false);
        Flight flight2 = new Flight("Berlin", "Paris", testDate.atTime(15, 30), 90, 7, true);
    ...
    void testFindAll() throws DatabaseActionException, SQLException {
        Flight flight = new Flight("Test", "FindAll", LocalDateTime.now().plusDays(1), 60, 5, false);
        int id = flightDao.save(flight);
    ...
    void testDelete() throws DatabaseActionException, SQLException {
        Flight flight = new Flight("Prague", "Vienna", LocalDateTime.now().plusDays(5), 75, 6, true);
    ...
    void testGetAvailableSeatsNumbers() throws DatabaseActionException, SQLException {
        Flight flight = new Flight("SeatTest", "Destination", LocalDateTime.now().plusDays(1), 60, 2, false);
        int id = flightDao.save(flight);
    ...
    void testFindAllId() throws DatabaseActionException, SQLException {
        Flight flight = new Flight("Test", "FindAllId", LocalDateTime.now().plusDays(1), 60, 5, false);
        int id = flightDao.save(flight);
    ...
    void testExistsById() throws DatabaseActionException, SQLException {
        Flight flight = new Flight("Exists", "Test", LocalDateTime.now().plusDays(1), 60, 5, false);
        int id = flightDao.save(flight);
