...
class ReservationDaoTest {
    ...
    void testHasTakenPlace() throws DatabaseActionException, SQLException {
        Flight pastFlight = new Flight("Past", "Flight", LocalDateTime.now().minusDays(1), 60, 5, false);
        Flight futureFlight = new Flight("Future", "Flight", LocalDateTime.now().plusDays(1), 60, 5, false);
    ...
    private Flight createTestFlight() {
        Flight flight = new Flight("Test", "Flight", LocalDateTime.now().plusDays(1), 60, 5, false);
        return flight;
    }
