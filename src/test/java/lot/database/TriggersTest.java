...
class TriggersTest {
    ...
    private int insertTestFlight(Connection conn) throws SQLException {
        try (Statement stmt = conn.createStatement()) {
            stmt.executeUpdate("""
                INSERT INTO flights (departure, destination, departureDate, duration, seatRowsAmount, twoWay)
                VALUES ('Warsaw', 'London', CURRENT_TIMESTAMP + INTERVAL '1' DAY, 120, 10, false)
